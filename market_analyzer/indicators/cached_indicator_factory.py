...
from .trend.moving_averages import (
    calculate_ema_cached, calculate_ema_series_cached, calculate_sma_cached,
    get_ma_cross_signal_cached, clear_ma_cache
)
...
class CachedIndicatorFactory:
    ...
    def __init__(self, enable_cache: bool = True, default_symbol: str = None):
        ...
        logger.info(f"CachedIndicatorFactory initialized - Cache: {'Enabled' if enable_cache else 'Disabled'}")
    ...
    def ma_cross_signal(self, prices: Union[List[float], Any], 
        ...
        return get_ma_cross_signal_cached(prices, symbol, fast_period, slow_period, ma_type)
    
    def macd(self, prices: Union[List[float], Any], 
    ...
    def bollinger_bands(self, prices: Union[List[float], Any], 
                        period: int = 20, std_multiplier: float = 2.0) -> Dict[str, List[Optional[float]]]:
    ...
    def atr(self, highs: Union[List[float], Any], 
    ...
    def obv(self, prices: Union[List[float], Any], 
            volumes: Union[List[float], Any]) -> List[Optional[float]]:
        """Calculate OBV (will be enhanced with caching later)."""
        return calculate_obv_series(prices, volumes)
    
    def vwap(self, highs: Union[List[float], Any], 
             lows: Union[List[float], Any], 
             closes: Union[List[float], Any], 
        ...
        try:
            ...
            return {
                ...
                'macd': {
                    ...
                    'histogram': macd['macd_histogram'][-1] if macd['macd_histogram'] else None
                },
                'symbol': symbol
            }
