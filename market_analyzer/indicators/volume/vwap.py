...
def calculate_vwap_series(highs: Union[List[float], np.ndarray, pd.Series],
                         lows: Union[List[float], np.ndarray, pd.Series],
                         closes: Union[List[float], np.ndarray, pd.Series],
                         volumes: Union[List[float], np.ndarray, pd.Series],
...
def calculate_vwap_bands(highs: Union[List[float], np.ndarray, pd.Series],
                        lows: Union[List[float], np.ndarray, pd.Series],
                        closes: Union[List[float], np.ndarray, pd.Series],
                        volumes: Union[List[float], np.ndarray, pd.Series],
                        std_multiplier: float = 1.0,
                        period: Optional[int] = None) -> Dict[str, Optional[float]]:
    """
    ...
    min_len = min(len(highs_array), len(lows_array), len(closes_array), len(volumes_array))
    typical_prices = (highs_array[-min_len:] + lows_array[-min_len:] + closes_array[-min_len:]) / 3
...
def calculate_anchored_vwap(highs: Union[List[float], np.ndarray, pd.Series],
                           lows: Union[List[float], np.ndarray, pd.Series],
                           closes: Union[List[float], np.ndarray, pd.Series],
                           volumes: Union[List[float], np.ndarray, pd.Series],
                           anchor_index: int) -> Optional[float]:
    """
...
def vwap_signal(current_price: float,
               current_vwap: Optional[float],
               previous_price: Optional[float] = None,
               previous_vwap: Optional[float] = None) -> str:
    """
...
def calculate_vwap_deviation(current_price: float,
                            vwap: Optional[float]) -> Optional[float]:
    """
...
def calculate_volume_profile(prices: Union[List[float], np.ndarray, pd.Series],
                           volumes: Union[List[float], np.ndarray, pd.Series],
...
def find_poc(prices: Union[List[float], np.ndarray, pd.Series],
             volumes: Union[List[float], np.ndarray, pd.Series],
