...
def calculate_sma(prices: Union[List[float], np.ndarray, pd.Series], 
...
def calculate_sma_series(prices: Union[List[float], np.ndarray, pd.Series],
...
def calculate_ema_series(prices: Union[List[float], np.ndarray, pd.Series],
                         period: int) -> List[Optional[float]]:
    """
...
def calculate_ema_incremental(current_price: float,
...
def calculate_wma(prices: Union[List[float], np.ndarray, pd.Series],
                  period: int) -> Optional[float]:
    """
...
def calculate_dema(prices: Union[List[float], np.ndarray, pd.Series],
                   period: int) -> Optional[float]:
    """
...
def calculate_tema(prices: Union[List[float], np.ndarray, pd.Series],
                   period: int) -> Optional[float]:
    """
...
def calculate_ema_cached(prices: Union[List[float], np.ndarray, pd.Series],
                        symbol: str,
                        period: int,
                        enable_cache: bool = True) -> Optional[float]:
    """
...
def calculate_ema_series_cached(prices: Union[List[float], np.ndarray, pd.Series],
                               symbol: str,
                               period: int,
...
def calculate_sma_cached(prices: Union[List[float], np.ndarray, pd.Series],
                        symbol: str,
                        period: int,
                        enable_cache: bool = True) -> Optional[float]:
    """
    ...
    try:
        ...
        if (cached_result is not None and 
            ...
            cached_result.get('data_hash') == data_hash):
...
def _calculate_ema_incremental(prices: np.ndarray, cached_state: Dict,
...
def _extend_ema_series(prices: np.ndarray, cached_series: List[Optional[float]],
...
def get_ma_cross_signal_cached(prices: Union[List[float], np.ndarray, pd.Series],
                              symbol: str,
                              fast_period: int = 7,
                              slow_period: int = 26,
    ...
    try:
        ...
        return {
            ...
            'trend': 'bullish' if fast_ma and slow_ma and fast_ma > slow_ma else 'bearish' if fast_ma and slow_ma else 'neutral',
            'ma_type': ma_type,
        ...
        return {
            'fast_ma': None, 'slow_ma': None, 'bullish_cross': False,
            'bearish_cross': False, 'trend': 'unknown'
        }
