...
def calculate_bollinger_bands(prices: Union[List[float], np.ndarray, pd.Series],
                             period: int = 20,
                             std_dev: float = 2.0,
                             ma_type: str = 'sma') -> Dict[str, Optional[float]]:
    """
...
def calculate_bollinger_bands_series(prices: Union[List[float], np.ndarray, pd.Series],
                                    period: int = 20,
                                    std_dev: float = 2.0,
                                    ma_type: str = 'sma') -> Dict[str, List[Optional[float]]]:
    """
...
def calculate_bollinger_width(prices: Union[List[float], np.ndarray, pd.Series],
                             period: int = 20,
...
def calculate_bollinger_squeeze(prices: Union[List[float], np.ndarray, pd.Series],
                               period: int = 20,
                               std_dev: float = 2.0,
                               lookback: int = 120) -> Dict[str, Optional[Union[float, bool]]]:
    """
...
def bollinger_band_signal(prices: Union[List[float], np.ndarray, pd.Series],
                         period: int = 20,
...
def _calculate_bollinger_manual(prices: np.ndarray,
                               period: int,
                               std_dev: float,
                               ma_type: str) -> Dict[str, Optional[float]]:
...
def _calculate_bollinger_series_manual(prices: np.ndarray,
                                      period: int,
                                      std_dev: float,
