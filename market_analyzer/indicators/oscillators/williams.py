...
def calculate_williams_r(highs: Union[List[float], np.ndarray, pd.Series],
    ...
    if TALIB_AVAILABLE:
        try:
            williams_r = talib.WILLR(highs_array, lows_array, closes_array, timeperiod=period)
...
def calculate_williams_r_series(highs: Union[List[float], np.ndarray, pd.Series],
                               lows: Union[List[float], np.ndarray, pd.Series],
                               closes: Union[List[float], np.ndarray, pd.Series],
    ...
    # Manual calculation
    return _calculate_williams_r_series_manual(highs_array, lows_array, closes_array, period)


def williams_r_signal(current_value: Optional[float],
...
def calculate_williams_r_smooth(highs: Union[List[float], np.ndarray, pd.Series],
                               lows: Union[List[float], np.ndarray, pd.Series],
                               closes: Union[List[float], np.ndarray, pd.Series],
                               period: int = 14,
                               smooth_period: int = 3) -> Optional[float]:
    """
...
def calculate_williams_r_bands(highs: Union[List[float], np.ndarray, pd.Series],
                              lows: Union[List[float], np.ndarray, pd.Series],
                              closes: Union[List[float], np.ndarray, pd.Series],
                              period: int = 14,
                              overbought_level: float = -20,
                              oversold_level: float = -80) -> dict:
    """
...
def calculate_williams_r_divergence(prices: Union[List[float], np.ndarray, pd.Series],
...
def williams_r_trend_strength(values: List[Optional[float]], 
                             period: int = 10) -> str:
    """
...
def _calculate_williams_r_manual(highs: np.ndarray,
                                lows: np.ndarray,
                                closes: np.ndarray,
...
def _calculate_williams_r_series_manual(highs: np.ndarray,
                                       lows: np.ndarray,
                                       closes: np.ndarray,
