...
BOLLINGER_CONFIG = {"period": 20, "std_dev": 2.0, "ma_type": "sma"}

# Keltner Channels Configuration
KELTNER_CONFIG = {"period": 20, "multiplier": 2.0, "atr_period": 14}

# ATR Configuration
ATR_CONFIG = {"period": 14}

# ADX Configuration
ADX_CONFIG = {"period": 14}

# Williams %R Configuration
WILLIAMS_R_CONFIG = {"period": 14}

# CCI Configuration
CCI_CONFIG = {"period": 20}

# Volume Indicators Configuration
VOLUME_CONFIG = {
    "vwap": {"periods": [10]},  # Périodes VWAP
    "obv": {"ma_period": 10},  # OBV moving average
    "volume_ma": {"period": 20},  # Volume moving average
}
