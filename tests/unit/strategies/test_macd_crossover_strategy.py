...
class TestMACDCrossoverStrategy:
    ...
    def test_validate_data_valid(self, mock_strategy_data):
        ...
        strategy = MACD_Crossover_Strategy("BTCUSDC", mock_strategy_data['data'], indicators)
    ...
    def test_generate_signal_strong_separation_bonus(self, mock_strategy_data):
        ...
        assert result['side'] == "BUY"
        assert "séparation TRÈS forte" in result['reason'] or "séparation forte" in result['reason']
    ...
    def test_get_current_values_structure(self, mock_strategy_data):
        ...
        strategy = MACD_Crossover_Strategy("BTCUSDC", mock_strategy_data['data'], mock_strategy_data['indicators'])
        ...
        required_keys = [
            ...
            'rsi_14', 'confluence_score', 'market_regime'
        ]
    ...
    def test_get_current_price_valid(self, mock_strategy_data):
        ...
        strategy = MACD_Crossover_Strategy("BTCUSDC", data, mock_strategy_data['indicators'])
    ...
    @pytest.mark.parametrize("macd_line,macd_signal,expected_side", [
        (50.0, 45.0, "BUY"),   # MACD > Signal
        (45.0, 50.0, "SELL"),  # MACD < Signal
        (50.0, 50.0, None),    # MACD == Signal (trop proche)
    ])
    def test_generate_signal_different_crossovers(self, mock_strategy_data, macd_line, macd_signal, expected_side):
        ...
        indicators.update({
            ...
            'confluence_score': 70,
            'market_regime': 'TRENDING_BULL' if expected_side == "BUY" else 'TRENDING_BEAR',
