...
class RedisPublisher:
    ...
    async def publish_signal(self, signal: Dict[str, Any]):
        ...
        try:
            ...
            logger.debug(f"Signal publié: {signal['strategy']} {signal['symbol']} {signal['side']}")
    ...
    async def publish_strategy_performance(self, strategy_name: str, performance_data: Dict[str, Any]):
        """
