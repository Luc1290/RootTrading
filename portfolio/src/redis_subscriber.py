...
def _handle_cycle_created(channel, data):
    ...
    try:
        ...
        logger.info(
            f"📊 [MONITORING] Cycle créé: {cycle_id} | "
...
def _subscribe_cycle_completed():
    ...
    logger.info(
        "✅ Abonné au canal Redis des cycles complétés (monitoring uniquement)."
    )
...
def _handle_cycle_completed(channel, data):
    ...
    try:
        ...
        logger.info(
            f"💰 [MONITORING] Cycle complété: {cycle_id} | "
...
def _handle_cycle_canceled(channel, data):
    ...
    try:
        ...
        logger.info(
            f"🚫 [MONITORING] Cycle annulé: {cycle_id} | "
...
def _handle_cycle_failed(channel, data):
    ...
    try:
        ...
        logger.info(
            f"❌ [MONITORING] Cycle échoué: {cycle_id} | "
