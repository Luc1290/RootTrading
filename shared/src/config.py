...
SYMBOLS = ["BTCUSDC", "ETHUSDC", "SOLUSDC", "DOGEUSDC", "SHIBUSDC", "FLOKIUSDC", "PEPEUSDC", "WIFUSDC", "MKRUSDC", "DYDXUSDC", "GMXUSDC", "CAKEUSDC",  "LDOUSDC", "XRPUSDC", "ADAUSDC", "DOTUSDC", "AVAXUSDC", "PENGUUSDC", "XLMUSDC", "OMNIUSDC", "RESOLVUSDC", "ENSUSDC", "ACHUSDC", "BANANAS31USDC", "SANDUSDC", "FETUSDC", "TAOUSDC", "LINKUSDC", "INJUSDC", "API3USDC", "SUIUSDC", "STRKUSDC", "AAVEUSDC", "UNIUSDC", "ARBUSDC", "MATICUSDC", "NEARUSDC", "APTUSDC", "EGLDUSDC", "SEIUSDC", "LTCUSDC"]
INTERVAL = "1m"
