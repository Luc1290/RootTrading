...
# Les symboles peuvent être surchargés via TRADING_SYMBOLS dans .env
# Utiliser TOUS les symboles définis dans .env au lieu d'une liste par défaut limitée
SYMBOLS = os.getenv("TRADING_SYMBOLS", "BTCUSDC,ETHUSDC,SOLUSDC,XRPUSDC,ADAUSDC,AVAXUSDC,LINKUSDC,AAVEUSDC,SUIUSDC,LDOUSDC,ARBUSDC,POLUSDC,RENDERUSDC,FILUSDC,TONUSDC,NEARUSDC,OPUSDC,ATOMUSDC,DOTUSDC,TRXUSDC").split(",")
INTERVAL = "1m"
