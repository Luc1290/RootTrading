...
class Volatility_Regime_Validator(BaseValidator):
        ...
        try:
            ...
            if bb_width is not None:
                ...
                # Expansion extrême - attention aux reversals
                    ...
                    if signal_side == "BUY" and bb_position is not None and bb_position > 0.8:
                    ...
                    elif signal_side == "SELL" and bb_position is not None and bb_position < 0.2:
    ...
    def get_validation_score(self, signal: Dict[str, Any]) -> float:
        ...
        try:
            ...
            bb_squeeze = self.context.get('bb_squeeze', False)
            bb_expansion = self.context.get('bb_expansion', False)
            regime_strength = float(self.context.get('regime_strength', 0)) if self.context.get('regime_strength') is not None else 0.5
